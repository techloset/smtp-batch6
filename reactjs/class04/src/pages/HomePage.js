...
import TeamSectionRow from "../components/teamSectionRow/TeamSectionRow";
    ...
    return (
        <div>
            ...
            <section className="section category">
                <h2 className="section__title" style={{ backgroundColor: 'red', color: 'white' }} >{props.text} <br /> Category</h2>
